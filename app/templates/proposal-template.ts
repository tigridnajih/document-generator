        ...
        <div class="financial-info-group">
            ...
            <section class="section-container">
                ...
                <table class="pricing-table">
                    ...
                    <tbody>
                        <tr>
                            <td>Service Item 1<br><span class="text-muted">Detailed description of service</span></td>
                            <td>$1,000</td>
                            <td>1</td>
                            <td>$1,000</td>
                        </tr>
                        <tr>
                            <td>Service Item 2<br><span class="text-muted">Detailed description of service</span></td>
                            <td>$150/hr</td>
                            <td>10</td>
                            <td>$1,500</td>
                        </tr>
