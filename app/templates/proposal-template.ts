...
<head>
    ...
    <style>
         ...
         * 4. NO fixed heights (no vh if viewport is small).
        ...
        /* 1. RESET & BASE */
        * {
            box-sizing: border-box; /* RESTORED: Vital for consistent layout */
        }
        ...
        body {
            ...
            padding: 0;
            font-size: 14px;
            /* Removed height: 100% to rely on flow + min-height */
        }
        ...
        .cover {
            ...
            /* Sizing: Use physical units (safe A4 bounds) to ensure coverage regardless of viewport */
            min-height: 250mm; 
            width: 100%;
