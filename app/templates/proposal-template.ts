...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Lists */
        ol, ul { padding-left: 20px; margin-bottom: 15px; }
...
<body>
    ...
    <div class="page">
        <div class="page-content">
            ...
            <h3 style="margin-top: 20px;">Be Remarkable!</h3>
        </div>
    </div>
    ...
    <div class="page">
        <div class="page-content">
            ...
            <div style="margin-top: 30px; flex-grow: 1; display: flex; align-items: center;">
                <img src="https://pdsggplxeglpkmltwzlb.supabase.co/storage/v1/object/sign/Document_Images/Proposal/proposal_whytigrid.png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV83MTczYWI1Yy0xNDZjLTQ3NGEtYjNmNi1iNzYzZDExZDJmYzgiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJEb2N1bWVudF9JbWFnZXMvUHJvcG9zYWwvcHJvcG9zYWxfd2h5dGlncmlkLnBuZyIsImlhdCI6MTc2OTI3MzI3MCwiZXhwIjoyNzE1MzUzMjcwfQ.DsvpaP0ivDbNMuLPIDJvdkD4NRS9a7YEva5rZbTVFcA" 
                     alt="Why Tigrid" style="width: 100%; height: auto; border-radius: 8px;">
            </div>
        </div>
    </div>
...
[[project_timeline_section]]
    ...
    <div class="page">
        <div class="page-content">
            ...
            <h3 class="mt-20">Payment Details</h3>
            <ol>
                ...
                <li>An 18% GST will be applicable on the final invoice.</li>
            ...
            <div style="margin-top: 20px; border-top: 1px solid var(--border-light); padding-top: 20px;">
                ...
                <div style="display: grid; grid-template-columns: auto 1fr; column-gap: 20px; row-gap: 5px; font-weight: 600;">
    ...
    <div class="page">
        <div class="page-content">
            ...
            <p>I would like to express my heartfelt appreciation for your time and consideration in reviewing the
                proposal. Choosing Tigrid means choosing a partner who is dedicated to your success.</p>
            
            <p>Should you have any queries, require further clarification, or wish to discuss any aspect in more
                detail, please do not hesitate to reach out to us.</p>
            ...
            <div style="margin-top: 50px;">
                ...
                <div style="margin-top: 20px;">
                    <div style="font-size: 14pt; font-weight: 700;">Najih Sulthan</div>
